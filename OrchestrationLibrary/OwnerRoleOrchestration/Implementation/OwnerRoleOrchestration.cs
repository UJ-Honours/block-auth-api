...
{
    public class OwnerRoleOrchestration : IOwnerRoleOrchestration
    {
        private readonly IOwnerRoleContractManager _ContractManager;

        public OwnerRoleOrchestration(IOwnerRoleContractManager contractManager)
        {
            _ContractManager = contractManager;
        }

        public bool GetOwnerRoleOn()
        {
